...
import img1 from "@/assets/joints/joints-gallery-1.jpg";
import img2 from "@/assets/joints/joints-gallery-2.jpg";
import img3 from "@/assets/joints/joints-gallery-3.jpg";
import img4 from "@/assets/joints/joints-gallery-4.jpg";
import img5 from "@/assets/joints/joints-gallery-5.jpg";
import { ChevronLeft, ChevronRight } from "lucide-react";

const images = [
    { src: img1, title: "Deep Penetration", label: "Fast Relief" },
    { src: img2, title: "Joint Mobility", label: "Better Movement" },
    { src: img3, title: "Natural Healing", label: "Herbal Care" },
    { src: img4, title: "Muscle Relaxation", label: "Soothing Warmth" },
    { src: img5, title: "Active Lifestyle", label: "Pain Free" }
];

const JointsShowcaseSection = () => {
...
export default JointsShowcaseSection;
