    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-24 border-b border-white/10 pb-16">
            <motion.div
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {results.map((result, index) => (
                <motion.div
                  ...
                  className="bg-white/10 backdrop-blur-xl border border-white/30 p-10 rounded-[48px] shadow-xl hover:shadow-gold/5 transition-all duration-500 flex flex-col items-center group relative overflow-hidden"
                >
