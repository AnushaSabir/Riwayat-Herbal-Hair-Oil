          ...
          {ingredients.map((ingredient, index) => {
            ...
            return (
              <motion.div
                ...
                className="absolute z-10 p-5 bg-black/20 backdrop-blur-lg rounded-[24px] border border-black/30 shadow-md group cursor-pointer transition-all hover:bg-black/40 hover:shadow-gold/10"
                style={{
                  perspective: 800,
                }}
              >
