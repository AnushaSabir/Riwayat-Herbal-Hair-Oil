        ...
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col cursor-pointer" onClick={() => navigate("/")}>
              <AnimatedLogo className="text-xl font-display font-bold tracking-[0.3em] uppercase" textColor="text-foreground" glowColor="text-herbal drop-shadow-sm" bottleSrc={jointsBottle} />
        ...
        <div className="container mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <div className="mb-3 flex lg:justify-start">
              <AnimatedLogo className="text-5xl md:text-6xl lg:text-7xl font-display font-bold leading-[1.1] tracking-tight" textColor="text-herbal" glowColor="text-herbal drop-shadow-lg" bottleSrc={jointsBottle} />
            </div>
