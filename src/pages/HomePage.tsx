...
const products = [
  ...
  },
  {
    ...
    subTagline: "15 Organic Herbs",
    subTaglineColor: "text-red-500",
    description: "100% herbal solution with 15 powerful ingredients that relieves pain, reduces swelling and improves joint flexibility.",
