...
const products = [
  ...
  },
  {
    ...
    subTaglineColor: "text-red-500",
    description: "100% herbal solution with 17 powerful ingredients including Camel Hump Fat & Ostrich Oil that relieves pain, reduces swelling and improves joint flexibility.",
